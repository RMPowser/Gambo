...
#pragma region Instructions
	...
	const std::vector<Instruction> instructions8bit =
	{
		...
		{"LD (HL), B",1,8 ,&CPU::LD_aHL_B}, {"LD (HL), C",1,8 ,&CPU::LD_aHL_C  }, {"LD (HL), D"  ,1,8 ,&CPU::LD_aHL_D   }, {"LD (HL), E",1,8 ,&CPU::LD_aHL_E}, {"LD (HL), H"  ,1,8 ,&CPU::LD_aHL_H   }, {"LD (HL), L",1,8 ,&CPU::LD_aHL_L}, {"HALT"       ,1,4 ,&CPU::HALT     }, {"LD (HL), A",1,4 ,&CPU::LD_aHL_A}, {"LD A, B"     ,1,4 ,&CPU::LD_A_B        }, {"LD A, C"   ,1,4 ,&CPU::LD_A_C   }, {"LD A, D"     ,1,4 ,&CPU::LD_A_D     }, {"LD A, E" ,1,4 ,&CPU::LD_A_E }, {"LD A, H"    ,1,4 ,&CPU::LD_A_H    }, {"LD A, L" ,1,4 ,&CPU::LD_A_L  }, {"LD A, (HL)" ,1,8 ,&CPU::LD_A_aHL }, {"LD A, A" ,1,4 ,&CPU::LD_A_A },
		...
		{"SUB A, B"  ,1,4 ,&CPU::SUB_A_B }, {"SUB A, C"  ,1,4 ,&CPU::SUB_A_C   }, {"SUB A, D"    ,1,4 ,&CPU::SUB_A_D    }, {"SUB A, E"  ,1,4 ,&CPU::SUB_A_E }, {"SUB A, H"    ,1,4 ,&CPU::SUB_A_H    }, {"SUB A, L"  ,1,4 ,&CPU::SUB_A_L }, {"SUB A, (HL)",1,8 ,&CPU::SUB_A_aHL}, {"SUB A, A"  ,1,4 ,&CPU::SUB_A_A }, {"SBC A, B"    ,1,4 ,&CPU::ADC_A_B       }, {"SBC A, C"  ,1,4 ,&CPU::ADC_A_C  }, {"SBC A, D"    ,1,4 ,&CPU::ADC_A_D    }, {"SBC A, E",1,4 ,&CPU::ADC_A_E}, {"SBC A, H"   ,1,4 ,&CPU::ADC_A_H   }, {"SBC A, L",1,4 ,&CPU::ADC_A_L }, {"SBC A, (HL)",1,8 ,&CPU::ADC_A_aHL}, {"SBC A, A",1,4 ,&CPU::ADC_A_A},
