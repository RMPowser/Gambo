...
#pragma region Instructions
	...
	const std::vector<Instruction> instructions8bit =
	{
		...
		{"LD (HL), B",1,8 ,&CPU::LD_aHL_B}, {"LD (HL), C",1,8 ,&CPU::LD_aHL_C  }, {"LD (HL), D"  ,1,8 ,&CPU::LD_aHL_D   }, {"LD (HL), E",1,8 ,&CPU::LD_aHL_E}, {"LD (HL), H"  ,1,8 ,&CPU::LD_aHL_H   }, {"LD (HL), L",1,8 ,&CPU::LD_aHL_L}, {"HALT"       ,1,4 ,&CPU::HALT     }, {"LD (HL), A",1,4 ,&CPU::LD_aHL_A}, {"LD A, B"     ,1,4 ,&CPU::LD_A_B        }, {"LD A, C"   ,1,4 ,&CPU::LD_A_C   }, {"LD A, D"     ,1,4 ,&CPU::LD_A_D     }, {"LD A, E" ,1,4 ,&CPU::LD_C_E }, {"LD A, H"    ,1,4 ,&CPU::LD_A_H    }, {"LD A, L" ,1,4 ,&CPU::LD_A_L  }, {"LD A, (HL)" ,1,8 ,&CPU::LD_A_aHL }, {"LD A, A" ,1,4 ,&CPU::LD_A_A },
